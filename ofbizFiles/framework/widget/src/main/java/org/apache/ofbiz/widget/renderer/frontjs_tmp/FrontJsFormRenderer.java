...
public final class FrontJsFormRenderer implements FormStringRenderer {
    ...
    */
    ...
    private void putIfNotEmpty(Map<String, Object> attributes, String key, Object value ) {
        if (UtilValidate.isNotEmpty(value)) attributes.put(key, value);
    }
...
//            cb.put("value", value);
    ...
    public void renderTextareaField(Appendable writer, Map<String, Object> context, TextareaField textareaField) {
        ...
        attributes.put("name", name);
        attributes.put("value", value);
        putIfNotEmpty(attributes, "className", className);
        putIfNotEmpty(attributes, "alert", alert);
        putIfNotEmpty(attributes, "cols", cols);
        putIfNotEmpty(attributes, "rows", rows);
        if (maxlength > -1) attributes.put("maxlength", maxlength);
        putIfNotEmpty(attributes, "id", id);
        putIfNotEmpty(attributes, "readonly", readonly);
        putIfNotEmpty(attributes, "visualEditorEnable", visualEditorEnable);
        putIfNotEmpty(attributes, "language", language);
        putIfNotEmpty(attributes, "buttons", buttons);
        putIfNotEmpty(attributes, "tabindex", tabindex);
    ...
    public void renderDateTimeField(Appendable writer, Map<String, Object> context, DateTimeField dateTimeField) {
        ...
        */
        ...
        putIfNotEmpty(attributes, "className", className);
        putIfNotEmpty(attributes, "alert", alert);
        putIfNotEmpty(attributes, "title", localizedInputTitle);
        putIfNotEmpty(attributes, "size", size);
        putIfNotEmpty(attributes, "maxlength", maxlength);
        putIfNotEmpty(attributes, "step", step);
        putIfNotEmpty(attributes, "timeValues", timeValues.toString());
        putIfNotEmpty(attributes, "id", id);
        putIfNotEmpty(attributes, "event", event);
        putIfNotEmpty(attributes, "action", action);
        putIfNotEmpty(attributes, "dateType", dateTimeField.getType());
        putIfNotEmpty(attributes, "shortDateInput", shortDateInput);
        putIfNotEmpty(attributes, "timeDropdownParamName", timeDropdownParamName);
        putIfNotEmpty(attributes, "defaultDateTimeString", defaultDateTimeString);
        putIfNotEmpty(attributes, "localizedIconTitle", localizedIconTitle);
        putIfNotEmpty(attributes, "timeDropdown", timeDropdown);
        putIfNotEmpty(attributes, "timeHourName", timeHourName);
        putIfNotEmpty(attributes, "classString", classString);
        putIfNotEmpty(attributes, "hour1", hour1);
        putIfNotEmpty(attributes, "hour2", hour2);
        putIfNotEmpty(attributes, "timeMinutesName", timeMinutesName);
        putIfNotEmpty(attributes, "minutes", minutes);
        putIfNotEmpty(attributes, "isTwelveHour", isTwelveHour);
        putIfNotEmpty(attributes, "ampmName", ampmName);
        putIfNotEmpty(attributes, "amSelected", amSelected);
        putIfNotEmpty(attributes, "pmSelected", pmSelected);
        putIfNotEmpty(attributes, "compositeType", compositeType);
        putIfNotEmpty(attributes, "mask", formattedMask);
        putIfNotEmpty(attributes, "tabindex", tabindex);

        this.addAsterisks(attributes, context, modelFormField);
        this.appendTooltip(attributes, context, modelFormField);
        this.output.putScreen("DateTimeField", attributes, name, value);
    }
    ...
    public void renderDropDownField(Appendable writer, Map<String, Object> context, DropDownField dropDownField) {
        ...
        attributes.put("formName", formName);
        attributes.put("name", name);
        attributes.put("currentValue", currentValue);
        if (textSize > 0) attributes.put("textSize", textSize);
        putIfNotEmpty(attributes, "className", className);
        putIfNotEmpty(attributes, "alert", alert);
        putIfNotEmpty(attributes, "id", id);
        putIfNotEmpty(attributes, "multiple", multiple);
        putIfNotEmpty(attributes, "otherFieldName", otherFieldName);
        if (event != null) {
            putIfNotEmpty(attributes, "event", event);
        }
        if (action != null) {
        ...
        putIfNotEmpty(attributes, "size", size);
        putIfNotEmpty(attributes, "firstInList", firstInList);
        putIfNotEmpty(attributes, "explicitDescription", explicitDescription);
        putIfNotEmpty(attributes, "allowEmpty", allowEmpty);
        putIfNotEmpty(attributes, "options", options);
        putIfNotEmpty(attributes, "fieldName", fieldName);
        putIfNotEmpty(attributes, "otherFieldName", otherFieldName);
        putIfNotEmpty(attributes, "otherValue", otherValue);
        putIfNotEmpty(attributes, "otherFieldSize", otherFieldSize);
        putIfNotEmpty(attributes, "dDFCurrent", dDFCurrent);
        putIfNotEmpty(attributes, "ajaxEnabled", ajaxEnabled);
        putIfNotEmpty(attributes, "noCurrentSelectedKey", noCurrentSelectedKey);
        putIfNotEmpty(attributes, "ajaxOptions", ajaxOptions.toString());
        putIfNotEmpty(attributes, "conditionGroup", conditionGroup);
        putIfNotEmpty(attributes, "tabindex", tabindex);
        if (ajaxEnabled) {
            putIfNotEmpty(attributes, "frequency",     autoComplete.getFrequency());
            putIfNotEmpty(attributes, "minChars",      autoComplete.getMinChars());
            putIfNotEmpty(attributes, "choices",       autoComplete.getChoices());
            putIfNotEmpty(attributes, "autoSelect",    autoComplete.getAutoSelect());
            putIfNotEmpty(attributes, "partialSearch", autoComplete.getPartialSearch());
            putIfNotEmpty(attributes, "partialChars",  autoComplete.getPartialChars());
            putIfNotEmpty(attributes, "ignoreCase",    autoComplete.getIgnoreCase());
            putIfNotEmpty(attributes, "fullSearch",    autoComplete.getFullSearch());
        }

        this.appendTooltip(attributes, context, modelFormField);
        this.output.putScreen("DropDownField", attributes, name, currentValue);
        ...
        if (subHyperlink != null && subHyperlink.shouldUse(context)) {
            makeHyperlinkString(attributes, subHyperlink, context);
        }
    }
    ...
    public void renderCheckField(Appendable writer, Map<String, Object> context, CheckField checkField) {
        ...
        attributes.put("name", name);
        attributes.put("currentValue", currentValue);
        attributes.put("items", items.toString());
        putIfNotEmpty(attributes, "className", className);
        putIfNotEmpty(attributes, "alert", alert);
        putIfNotEmpty(attributes, "id", id);
        putIfNotEmpty(attributes, "conditionGroup", conditionGroup);
        putIfNotEmpty(attributes, "allChecked", allChecked );
        putIfNotEmpty(attributes, "event", event);
        putIfNotEmpty(attributes, "action", action);
        putIfNotEmpty(attributes, "tabindex", tabindex);
        putIfNotEmpty(attributes, "disabled", disabled);

        this.appendTooltip(attributes, context, modelFormField);
        // TODO should check why there is no record added (name, currentValue
        this.output.putScreen("CheckField", attributes);
    }
    ...
    public void renderRadioField(Appendable writer, Map<String, Object> context, RadioField radioField) {
        ...
        this.appendTooltip(attributes, context, modelFormField);
        this.output.putScreen("RadioField", attributes, name, currentValue);
    }
    ...
    public void renderSubmitField(Appendable writer, Map<String, Object> context, SubmitField submitField) {
        ...
        /* with frontJs, ajaxUrl is build in the front
        ...
        if (ajaxEnabled) {
            attributes.put("containerId", formId);
        }
        if (ajaxEnabled) {
            attributes.put("ajaxUrl", ajaxUrl);
        }
        */
        Map<String, Object> attributes = new HashMap<>();
        attributes.put("formName", formName);
        attributes.put("name", name);
        putIfNotEmpty(attributes, "buttonType", buttonType);
        putIfNotEmpty(attributes, "className", className);
        putIfNotEmpty(attributes, "alert", alert);
        putIfNotEmpty(attributes, "title", encode(title, modelFormField, context));
        putIfNotEmpty(attributes, "event", event);
        putIfNotEmpty(attributes, "action", action);
        putIfNotEmpty(attributes, "imgSrc", imgSrc);
        putIfNotEmpty(attributes, "confirmation", confirmation);
        putIfNotEmpty(attributes, "tabindex", modelFormField.getTabindex());
        this.output.putScreen("SubmitField", attributes);
    }
    ...
    public void renderResetField(Appendable writer, Map<String, Object> context, ResetField resetField) {
        ...
        hashMapStringObject.put("ResetField", cb);
    ...
    public void renderHiddenField(Appendable writer, Map<String, Object> context, ModelFormField modelFormField, String value) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("HiddenField", cb);
        this.output.putScreen(hashMapStringObject);
    }
        ...
        if (UtilValidate.isNotEmpty(titleText)) {
            if (" ".equals(titleText)) {
                ...
                if (UtilValidate.isNotEmpty(modelFormField.getHeaderLink())) {
                    ...
                    HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
                    hashMapStringObject.put("FieldTitle", cb);
                    this.output.putScreen(hashMapStringObject);
                    ...
                    HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
                    hashMapStringObject.put("HyperlinkTitle", cb);
                    this.output.putScreen(hashMapStringObject);
                } else {
                    sb.append(titleText);
                }
    ...
    public void renderMultiFormClose(Appendable writer, Map<String, Object> context, ModelForm modelForm) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("MultiFormClose", cb);
        this.output.popScreen(hashMapStringObject);
    ...
    public void renderFormatEmptySpace(Appendable writer, Map<String, Object> context, ModelForm modelForm) {
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("FormatEmptySpace", new HashMap<>());
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderRangeFindField(Appendable writer, Map<String, Object> context, RangeFindField rangeFindField) {
        ...
        this.appendTooltip(cb, context, modelFormField);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("RangeFindField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderDateFindField(Appendable writer, Map<String, Object> context, DateFindField dateFindField) {
        ...
        this.appendTooltip(cb, context, modelFormField);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("DateFindField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderLookupField(Appendable writer, Map<String, Object> context, LookupField lookupField) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("LookupField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderFileField(Appendable writer, Map<String, Object> context, FileField textField) {
        ...
        this.appendTooltip(cb, context, modelFormField);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("FileField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderPasswordField(Appendable writer, Map<String, Object> context, PasswordField passwordField) {
        ...
        this.appendTooltip(cb, context, modelFormField);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("PasswordField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderImageField(Appendable writer, Map<String, Object> context, ImageField imageField) {
        ...
        this.appendTooltip(cb, context, modelFormField);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("ImageField", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void renderFieldGroupOpen(Appendable writer, Map<String, Object> context, ModelForm.FieldGroup fieldGroup) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("FieldGroupOpen", cb);
        this.output.pushScreen(hashMapStringObject);
    }
    ...
    public void renderFieldGroupClose(Appendable writer, Map<String, Object> context, ModelForm.FieldGroup fieldGroup) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("FieldGroupClose", cb);
        this.output.popScreen(hashMapStringObject);
    }
    ...
    public void renderBanner(Appendable writer, Map<String, Object> context, ModelForm.Banner banner) {
        ...
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("Banner", cb);
        this.output.putScreen(hashMapStringObject);
    }
    ...
    public void addAsterisks(Map<String, Object> attributes, Map<String, Object> context, ModelFormField modelFormField) {
        ...
        if (modelFormField.getRequiredField()) {
            ...
            Map<String, Object> requireAttr = new HashMap<>();
            requireAttr.put("requiredField", requiredField);
            requireAttr.put("requiredStyle", requiredStyle);
            attributes.put("required", requireAttr);
        }
    }
    ...
    public void makeHiddenFormLinkAnchor(Appendable writer, String linkStyle, String description, String confirmation, ModelFormField modelFormField, HttpServletRequest request, HttpServletResponse response, Map<String, Object> context) {
        if (UtilValidate.isNotEmpty(description) || UtilValidate.isNotEmpty(request.getAttribute("image"))) {
            ...
            cb.put("confirmation ", confirmation);
            HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
            hashMapStringObject.put("HiddenFormLinkAnchor", cb);
            this.output.putScreen(hashMapStringObject);
        }
    }
/*
...
*/
    public void renderContainerFindField(Appendable writer, Map<String, Object> context, ContainerField containerField) {
        ...
        cb.put("className", className);
        HashMap<String, Object> hashMapStringObject = new HashMap<String, Object>();
        hashMapStringObject.put("ContainerFindField", cb);
        this.output.putScreen(hashMapStringObject);
    }
}
