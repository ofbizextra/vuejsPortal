...
Release 17.12, La traduction en français est en cours, donc de nombreuse partie sont encore en anglais, elle est basé sur la version 1827961 de la version anglaise.
:imagesdir: ./images
ifdef::backend-pdf[]
...
include::../../plugins/vuejsPortal/src/docs/asciidoc/FrontJsPortal_fr.adoc[leveloffset=+1]
...
include::../../plugins/vuejsPortal/src/docs/asciidoc/webhelp_example_fr.adoc[leveloffset=+2]


=== Web tools

include::../../plugins/example/src/docs/asciidoc/example_fr.adoc[leveloffset=+2]
