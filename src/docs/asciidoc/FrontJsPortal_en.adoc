...
The first goal of using a javascript framework for user interface is to increase interactive elements in screen, even if
theses screens are based on standard modules :
